...
async function DikeWasm(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("DikeWasmES6.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("DikeWasmES6.wasm", import.meta.url).href;
}
...
function assignWasmExports(wasmExports) {
  ...
  _inflateCreate = Module["_inflateCreate"] = wasmExports["u"];
  _inflateReset = Module["_inflateReset"] = wasmExports["v"];
  _inflateSetOptions = Module["_inflateSetOptions"] = wasmExports["w"];
  _inflateAddTrack = Module["_inflateAddTrack"] = wasmExports["x"];
  _inflateInflate = Module["_inflateInflate"] = wasmExports["y"];
  _malloc = Module["_malloc"] = wasmExports["z"];
  _free = Module["_free"] = wasmExports["A"];
  _calculateDestroy = Module["_calculateDestroy"] = wasmExports["B"];
  _calculateCreate = Module["_calculateCreate"] = wasmExports["C"];
  _calculateReset = Module["_calculateReset"] = wasmExports["D"];
  _calculateSetMethod = Module["_calculateSetMethod"] = wasmExports["E"];
